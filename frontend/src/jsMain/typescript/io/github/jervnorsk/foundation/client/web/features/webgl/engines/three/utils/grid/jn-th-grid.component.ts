...
import {ThGroup} from "ngx-three";

export interface JnThGridProps {
    size?: {
        x: number,
        y: number,
    },
...
@Component({
    selector: 'jn-th-grid',
    templateUrl: './jn-th-grid.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class JnThGrid extends ThGroup implements JnThGridProps, AfterViewInit {
